...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('wallet_movements', function (Blueprint $table) {
            ...
            $table->bigInteger('source_amount')->comment('Amount in the source currency (only positive values, even for withdrawals)');
            ...
            $table->decimal('fx_fee_percentage', 20, 2)->nullable()->comment('Exchange operation total percentage fee (e.g. fee + iof) (fees increase the exchange rate)');
            ...
            $table->bigInteger('target_amount')->comment('Amount in the target currency (only positive values, even for withdrawals)');
